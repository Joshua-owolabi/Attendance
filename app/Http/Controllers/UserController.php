...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $totalUsers = User::where('user_rank', '!=', 'developer')->count();
        $total_attendance = AttendancePicking::all()->count();
        return view('admin.users', ['users' => $users, 'total_attendance' => $total_attendance, 'totalUsers' => $totalUsers]);
    }
    ...
    public function search_members(SearchRequest $request)
    {
        ...
        return view('admin.search')->with(['users' => $members, 'query' => $query]);
    }
