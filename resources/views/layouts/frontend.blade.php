...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<head>
		...
		<!-- Stylesheets
	============================================= -->
		<link href="http://fonts.googleapis.com/css?family=Lato:300,400,400i,700|Montserrat:400,700|Merriweather"
		...
		<style>
			...
			li>a.side-links:hover {
				color: #59BA41 !important;
			}

			.button-border.button-green {
				border-color: #2b7917 !important;
				color: #2b7917;
			}
			...
			.button-border.button-green.button-fill:before {
				background-color: #2b7917 !important;
			}
		</style>
	</head>
