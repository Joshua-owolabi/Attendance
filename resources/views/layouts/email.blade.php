...
<head>
    ...
    <title>LearnBase</title> <!-- The title tag shows in email notifications-->
    <style>
      * {
        ...
        <div style="max-width: 620px; margin: auto;" class="email-container">
            <table class="container" role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 620px;">
                     <tr>
                                ...
                                <!-- <img src="https://reg.smetoolkit.ng/images/logok.png" aria-hidden="true" alt="SMEToolkit Logo" border="0" align="center" style="width: 147px; max-width: 147px; font-family: 'Poppins', sans-serif; font-size: 15px; line-height: 20px; color: #555555;"> -->
                                </td>
                            </tr>
                <!-- Banner Image: BEGIN -->
