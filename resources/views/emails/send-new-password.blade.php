                        ...
                        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td class="header-td" style="padding:6px 60px 13px 40px; font-family: 'Poppins', sans-serif; text-align:center;">
                                    <h1 class="h1-title" style="padding:0px 0px 10px 0px; font-family: 'Poppins', sans-serif; font-size: 24px; line-height: 41px; color: green; font-weight: 600;"><a href="#" class="h1-title-a" style="color: #111111; text-decoration: none;">Sanctuary Membership Application</a></h1>
