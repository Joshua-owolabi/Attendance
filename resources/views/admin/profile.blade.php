          ...
          <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="form-control" id="department" name="department" value="{{$user->department}}">
                              ...
                              <option value="Biochemistry">Physics</option>
                          </select> 
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value="{{ $user->room_number }}" name="room_number" maxlength="4">
                        </div>
                      </div>
                       <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Phone Number</label>
                          <input type="text" class="form-control" value="{{ $user->phone_number }}" name="phone_number" maxlength="11">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5" name="about_me" value="{{ $user->about_me }}"></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="col-md-5">
              <div class="card card-profile">
                ...
                <div class="card-body">
                  <h3 class="card-category text-gray">{{ ucfirst($user->sur_name) }}   {{ ucfirst($user->first_name) }}  {{ ucfirst($user->last_name) }} </h3>
                <div class="row mb-3">
                    <div class="col">
                  ...
                  <div class="progress-container mt-3">
                    ...
                    <div class="progress">
                        <div class="progress-bar @if($user->attendance <= 40) progress-bar-danger @else progress-bar-success @endif" role="progressbar" aria-valuenow="{{ $user->attendance }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ $user->attendance }}%;"> <strong style="@if($user->attendance === 0) color: #000; @else color: #fff; @endif">{{ $user->attendance }}%</strong>
                        </div>
                    </div>
                  </div>
                </div>
