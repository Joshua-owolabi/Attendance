        ...
        <div class="row">
          <div class="col-md-8 center-element">
            <div class="card card-profile">
              ...
              <div class="card-body">
                <h3 class="card-category text-gray">{{ ucfirst($member->sur_name) }} {{ ucfirst($member->first_name) }}
                  {{ ucfirst($member->last_name) }} </h3>
                <div class="row mb-3">
                  <div class="col-md-4">
                    <h4 class="card-title">Unit Rank: <strong>{{ ucfirst($member->user_rank) }}</strong></h4>
                  </div>
                  <div class="col-md-4">
                    <h4 class="card-title">Level: <strong>{{ ucfirst($member->level) }} Level</strong></h4>
                  </div>
                  <div class="col-md-4">
                    <h4 class="card-title">
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-md-6">
                    <h4 class="card-title">
                      Date Of Birth: <strong>{{ \Carbon\Carbon::parse($member->dob)->format('D d M, Y')}}</strong>
                    </h4>
                  </div>
                </div>
                <div class="row mb-2">
                ...
                <div class="progress-container mt-3 mb-3">
                  <span class="progress-badge">{{ ucfirst($member->first_name) }}'s Attendance Progress</span>
                  <div class="progress">
                    <div
                      class="progress-bar @if($member->attendance <= 40) progress-bar-danger @else progress-bar-success @endif"
                      role="progressbar" aria-valuenow="{{ $member->attendance }}" aria-valuemin="0" aria-valuemax="100"
