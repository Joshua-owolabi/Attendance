                ...
                <div class="col-md-12">
                        ...
                        <form class="navbar-form" action="{{ route('search-members') }}" method="GET">
                            <span class="bmd-form-group">
                                <div class="input-group no-border">
                                    <input type="text" value="{{ request()->input('query') }}" name="query"
                    ...
                    <div class="card mt-20">
                        <div class="card-header card-header-success">
                            ...
                            <p class="card-category"><strong>Total Registered Members: {{ $totalUsers }}</strong></p>
                        </div>
                        <div class="card-body">
                                            ...
                                            <td>
                                                <div class="nav-item dropdown">
                                                    <a class="nav-link" href="" id="navbarDropdownProfile"
                                                        ...
                                                        aria-expanded="false">
                                                        <p style="font-size: 32px; color: #66bb6a;">⋮</p>
                                                        <div class="ripple-container"></div>
                                                    </a>
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ route('view-member', $user->id) }}">View
                                                            Profile</a>
                                                    </div>
                                                </div>
                                            </td>
