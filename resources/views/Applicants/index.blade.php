...
<section class="section py-150" style="background-image: url({{ asset('images/sample-2.jpg') }});" data-overlay="5">
  <div class="container">
    ...
    <form class="section-dialog section-dialog-lg bg-gray py-40" action="{{ route('membership.store') }}" method="POST">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group input-group input-group-lg">
            ...
            <input type="text" class="form-control @error('sur_name') is-invalid @enderror" placeholder="Surname"
              name="sur_name" value="{{ old('sur_name') }}" required autofocus>
            @error('sur_name')
        ...
        <div class="col-md-6">
          <div class="form-group input-group input-group-lg">
            ...
            <input type="text" class="form-control @error('first_name') is-invalid @enderror" placeholder="First Name"
              value="{{ old('first_name') }}" required autofocus name="first_name">
            @error('first_name')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="col-md-6">
          <div class="form-group input-group input-group-lg">
            ...
            <input type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name"
              placeholder="Last Name" value="{{ old('last_name') }}" required autofocus>
            @error('last_name')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="col-md-6">
          <div class="form-group input-group input-group-lg">
            ...
            <input type="text" class="form-control @error('other_names') is-invalid @enderror"
              placeholder="Other Names (optional)" name="other_names" value="{{ old('other_names') }}" autofocus>
            @error('other_names')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
      ...
      <div class="form-group input-group input-group-lg">
        <span class="input-group-addon"><i class="fa fa-building"></i></span>
        <input type="text" class="form-control @error('room_number') is-invalid @enderror" placeholder="Room Number"
          maxlength="4" name="room_number" value="{{ old('room_number') }}" required autofocus>
        @error('room_number')
        <span class="invalid-feedback" role="alert">
          <strong>{{ $message }}</strong>
        </span>
      ...
      <div class="form-group input-group input-group-lg">
        ...
        <input type="text" class="form-control @error('email') is-invalid @enderror"
          placeholder="Enter Webmail or Gmail" name="email" value="{{ old('email') }}" required autofocus>
        @error('email')
        <span class="invalid-feedback" role="alert">
          <strong>{{ $message }}</strong>
        </span>
      ...
      <div class="row mb-20">
        ...
        <div class="col-md-6">
          <div class="form-group input-group input-group-lg">
            <span class="input-group-addon"><i class="fa fa-building"></i></span>
            <input type="text" class="form-control @error('reg_no') is-invalid @enderror" placeholder="Reg Number"
              name="reg_no" value="{{ old('reg_no') }}" required maxlength="7">
            @error('reg_no')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
      ...
      <div class="form-group">
        ...
        <textarea class="form-control @error('joining_reason') is-invalid @enderror" rows="7" name="joining_reason"
          placeholder="Your message" value="{{ old('joining_reason') }}" required autofocus></textarea>
